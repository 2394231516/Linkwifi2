 ...
 * 描述：    TODO
 */
public class tenFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.turn_on:
                ...
                message.what = tenFragment.TURN_ON;
            ...
            case R.id.turn_off:
                ...
                message2.what = tenFragment.TURN_OFF;
