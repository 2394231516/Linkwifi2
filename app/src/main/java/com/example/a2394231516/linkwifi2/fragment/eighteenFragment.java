 ...
 * 描述：    TODO
 */
public class eighteenFragment extends android.support.v4.app.Fragment implements View.OnClickListener {
    ...
    */
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 1:
                    mStatue.setText("状态：已经发送打开指令01 05 0FA0 FF00 8F 0C");
                    break;
                case 2:
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.turn_on:
                ...
                message.what = eighteenFragment.TURN_ON;
            ...
            case R.id.turn_off:
                ...
                message2.what = eighteenFragment.TURN_OFF;
